...
export const adminItems: AdminSidebarNavItem[] = [
  ...
  { title: "Courses", url: "/admin/courses", icon: GraduationCap, roles: ["admin", "teacher"], color: "text-green-600" },
  { title: "Students", url: "/admin/students", icon: Users, roles: ["admin", "teacher"], color: "text-purple-600" },
  ...
  { title: "Reviews", url: "/admin/reviews", icon: Megaphone, roles: ["admin", "teacher"], color: "text-pink-600" },
  ...
  { title: "Telegram Channels", url: "/admin/telegram-channels", icon: Send, roles: ["admin", "teacher"], color: "text-blue-500" },
