...
export const quickAccessItems: QuickAccessItem[] = [
  { title: "Live Exam", icon: ListChecks, color: "text-red-500", border: "border-red-500", bg: "bg-red-50 dark:bg-red-950", url: "/dashboard/live-exam" },
  { title: "Live Class", icon: Video, color: "text-blue-500", border: "border-blue-500", bg: "bg-blue-50 dark:bg-blue-950", url: "/dashboard/live-class" },
  { title: "My Courses", icon: BookOpen, color: "text-indigo-500", border: "border-indigo-500", bg: "bg-indigo-50 dark:bg-indigo-950", url: "/dashboard/my-courses" },
  ...
  { title: "My Mistakes", icon: AlertCircle, color: "text-red-600", border: "border-red-600", bg: "bg-red-50 dark:bg-red-950", url: "/dashboard/my-mistakes" },
  ...
  { title: "Profile", icon: User, color: "text-slate-500", border: "border-slate-500", bg: "bg-slate-50 dark:bg-slate-950", url: "/dashboard/profile" },
];
