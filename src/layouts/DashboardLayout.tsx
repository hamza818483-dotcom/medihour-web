  ...
  return (
    ...
    <SidebarProvider>
      <div className="min-h-screen w-full bg-[#e6e9fd] dark:bg-background text-foreground flex flex-col print:block print:h-auto print:overflow-visible">
        ...
        <header className="sticky top-0 z-10 flex h-14 items-center border-b bg-white/95 dark:bg-background/95 backdrop-blur px-4 supports-[backdrop-filter]:bg-white/60 dark:supports-[backdrop-filter]:bg-background/60 print:hidden">
              ...
              <div className="flex items-center gap-2">
                {location.pathname === "/dashboard" ? (
                  <Link to="/" className="flex items-center shrink-0" aria-label="Go to homepage">
                    <img src="/logo.png" alt="MediHour Logo" className="h-8 w-auto object-contain" />
                  </Link>
                ) : (
                  <button
